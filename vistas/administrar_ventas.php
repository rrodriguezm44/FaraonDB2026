...
if (isset($_SESSION['usuario'])) {
  ...
  $idPerfilUsuario = $_SESSION["usuario"]->id_perfil_usuario;
  $nombreUsuario = $_SESSION["usuario"]->nombre_usuario;
} else {
  exit();
}

// Determinar el título según el perfil
$tituloPagina = ($idPerfilUsuario == 1) ? "Administrar Ventas" : "Mis Ventas";
?>
  ...
  <div class="container-fluid">
    <div class="content pb-2">
      <div class="container-fluid">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            <?php if ($idPerfilUsuario == 1): ?>
            <div class="alert alert-info">
              <i class="fas fa-info-circle"></i> <strong>Administrador:</strong> Puede observar todas las ventas del
              sistema.
            </div>
            <?php else: ?>
            <div class="alert alert-warning">
              <i class="fas fa-user"></i> <strong>Vendedor:</strong> Solo puede observar sus propias ventas. Usuario:
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="form-floating mb-2">
                ...
                <select class="form-select select2 fs-sm" id="selCliente" aria-label="Floating label select example"
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="form-floating mb-2">
                ...
                <select class="form-select select2 fs-sm" aria-label="Floating label select example"
                  id="selDocumentoVenta" name="selDocumentoVenta">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="form-floating mb-2">
                <select class="form-select select2 fs-sm" aria-label="Floating label select example" id="selTipoPago"
                  name="selTipoPago">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="input-group mb-3">
                ...
                <div class="form-floating flex-grow-1">
                  <input type="text" class="form-control form-control-sm etimepicker-input fs-sm" id="iptFechaEntrega"
...
<style>
.bg-light-green {
  background-color: rgb(100, 156, 113) !important;
  ...
  $.ajax({
    ...
    success: function(vendedores) {
      ...
      $.each(vendedores, function(index, vendedor) {
        $("#selVendedor").append('<option value="' + vendedor.id_usuario + '">' + vendedor
  ...
  table = $('#lstVentas').DataTable({
    ...
    ajax: {
      ...
      data: {
        ...
        'idUsuario': <?php echo $usuarioID; ?>,
        'idPerfil': <?php echo $idPerfilUsuario; ?>
      }
    },
...
$(document).on('change', '#codigo_producto_add', function() {
  ...
  if (selectedProductCode) {
    ...
    $.post('ajax/get_producto_detalle.php', {
      codigo_producto: selectedProductCode
    }, function(response) {
...
$("#btnGuardarModificacion").on("click", function(e) {
  ...
  "Venta modificada"; // Descripción predeterminada o puede tomar el valor del número de boleta
